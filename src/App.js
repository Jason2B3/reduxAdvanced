...
function App() {
  ...
  useEffect(() => {
    ...
    const sendCartData = async function () {
      ...
      // prettier-ignore
      const response= await fetch("https://reduxadv-c13f7-default-rtdb.firebaseio.com/data.jsn", {
    ...
    // Invoke your async function within useEffect, then catch any errors
    // Alternative to the try/catch method
